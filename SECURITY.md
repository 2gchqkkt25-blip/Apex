...
If you discover a security vulnerability in Apex, please report it **privately** —
...
Apex is a **client-side player** — it ships with no servers, no bundled streams,
...
Apex is actively developed and security fixes target the **latest released version**.
