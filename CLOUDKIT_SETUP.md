...
| Reinstall leaves **Stremio** active, Xtream empty | Fixed Build 41 — preferred catalog default + first-time sync covers. On older builds: switch playlist → Sync, or open Settings to drain the deferred queue |
