...
struct ApexSyncBackground: View {
    ...
    var body: some View {
        ZStack {
            ...
            RadialGradient(
                colors: [themeManager.colors.accent.opacity(0.28), .clear],
                center: .top,
                startRadius: 24,
                endRadius: 440
            )
            ...
            RadialGradient(
                colors: [themeManager.colors.accent.opacity(0.16), .clear],
...
struct ApexSyncHero: View {
    ...
    private var accent: Color { themeManager.colors.accent }
    ...
    var body: some View {
        ZStack {
            ...
            if isAnimating {
                Circle()
                    .stroke(accent.opacity(pulse ? 0.05 : 0.22), lineWidth: 1)
