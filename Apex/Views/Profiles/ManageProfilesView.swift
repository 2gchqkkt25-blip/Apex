        ...
        List {
            ...
            Section {
                ...
                if !premium.isPremium {
                    Text("Free includes one profile. Upgrade to Apex Pro for the whole household.")
                }
            }
            ...
            Section {
                ...
                Text("Choose a profile each time Apex launches. When off, Apex resumes the last profile you used.")
            }
