    ...
    /// is the primary; Apex plays each stream with it and falls back down the
        ...
        var body: some View {
            List {
                Section {
                    ...
                    Text("Apex plays each stream with the first engine and automatically falls back to the next if it can't be played. Drag to reorder.")
                }
            }
