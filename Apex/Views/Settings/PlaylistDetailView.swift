...
struct PlaylistDetailView: View {
    ...
    /// The localized label for the URL field.
    ...
    // MARK: - tvOS layout
        ...
        /// A prominent sync button placed right below the playlist name so it's
        /// visible immediately — no scrolling required. Mirrors the iOS toolbar
        /// refresh button that tvOS otherwise lacks.
        private var tvSyncNowButton: some View {
            Button {
                showSync = true
            } label: {
                HStack(spacing: 12) {
