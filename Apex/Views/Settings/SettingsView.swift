    ...
    // MARK: - iOS / macOS (grouped list)
        ...
        private var playerSection: some View {
            Section {
                ...
                Text("Apex plays each stream with your preferred engine and falls back to the next if it can't be played. Streams open in the selected external app instead, when one is installed.")
            }
        }
