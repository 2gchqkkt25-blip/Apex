...
import SwiftUI
    ...
    enum SettingsCategory: String, CaseIterable, Identifiable {
        case premium, playlists, mediaServers, profiles, appearance, content, home, topShelf, epg, search, subtitles, integrations, player, storage, about
    ...
    extension SettingsView {
        ...
        private var tvCreditsSection: some View {
            VStack(alignment: .leading, spacing: 16) {
                ...
                Text("Apex is free, open-source software, licensed under the GNU Affero General Public License v3.")
                    .font(.system(size: 22))
                    .foregroundStyle(.secondary)
                    .padding(.horizontal, TVSettingsMetrics.rowHPadding)
