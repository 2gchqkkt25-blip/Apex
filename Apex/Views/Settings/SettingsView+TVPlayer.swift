        ...
        var tvPlayerDetail: some View {
            VStack(alignment: .leading, spacing: 28) {
                ...
                VStack(alignment: .leading, spacing: 8) {
                    ...
                    Text("Streams open in the selected app instead of Apex's player. Downloads always play in Lume, and the built-in player is used when the app is not installed.")
                        .font(.system(size: 20))
                        .foregroundStyle(.secondary)
                        .padding(.horizontal, TVSettingsMetrics.rowHPadding)
                        .padding(.top, 6)
