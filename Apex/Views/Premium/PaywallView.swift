...
//  Apex
//
//  The Apex Pro paywall: benefits list + the two plans (monthly subscription,
    ...
    // MARK: - iOS / macOS
        ...
        private var header: some View {
            VStack(spacing: 10) {
                ...
                Text("Apex is free and open source. Pro supports development and unlocks a few extra conveniences.")
                    .font(.callout)
