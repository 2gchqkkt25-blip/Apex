...
enum SortStorageKey {
    static let liveCategories = "apex.sort.live.categories"
    static let liveContent = "apex.sort.live.content"
    static let movieCategories = "apex.sort.movies.categories"
    static let movieContent = "apex.sort.movies.content"
    static let seriesCategories = "apex.sort.series.categories"
    static let seriesContent = "apex.sort.series.content"
}
