        ...
        while true {
            ...
            do {
                ...
                if let http = response as? HTTPURLResponse {
                    ...
                    Logger.network.warning("[ImageDebug] HTTP \(http.statusCode) for \(url.absoluteString)")
                ...
                Logger.network.warning("[ImageDebug] Fetch failed for \(url.absoluteString): \(error.localizedDescription)")
                throw error
            }
        }
    }
