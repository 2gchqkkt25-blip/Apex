...
//
//  There is deliberately no in-app language picker — Apex relies on the
...
enum TMDBLanguageWatcher {
    ...
    private static let logger = Logger(subsystem: "com.streaminfinity.apex", category: "TMDBLanguage")
